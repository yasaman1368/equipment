    ...
    <div class="modal-content bg-light">
      ...
      <div class="modal-body" id="userManagementModalDiv">
        ...
        <ul class="nav nav-tabs" id="userManagementTabs" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="editing-user-locations-tab" data-bs-toggle="tab" data-bs-target="#editing-user-locations" type="button" role="tab" aria-controls="editing-user-locations" aria-selected="false">موقعیت</button>
          </li>
          <!-- <li class="nav-item" role="presentation">
        ...
        <div class="tab-content" id="userManagementTabsContent">
          ...
          <!-- locations -->
          <div class="tab-pane fade show " id="editing-user-locations" role="tabpanel" aria-labelledby="editing-user-location-tab">
            <div class="mt-3">
              <div class="current-locations">
                <h6>موقعیت های کاربر</h6>
                <div class="p-2"  id="currentLocations">
              ...
              <div class="addNewLocation">
                <div class="m-2 p-2 border rounded">
                  <h6>افزودن موقعیت </h6>
                  <hr>
                  <select id="editingLocationsSelector" class="mt-3 w-auto m-auto "></select>

                  <button
                    type="button"
                   data-selector-id="editingLocationsSelector"
                    class="btn btn-primary addLocationButton my-2">
                    افزودن موقعیت جدید
                  </button>
                </div>
                <button
