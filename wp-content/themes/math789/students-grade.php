                    ...
                    <div class="modal-body">
                        <form id="studentForm">
                            ...
                            <select class="form-select" id="studentClass" required>
                                <option value="7-1">هفتم ۱</option>
                                <option value="7-2">هفتم ۲</option>
                                <option value="8-1">هشتم ۱</option>
                                <option value="8-2">هشتم ۲</option>
                                <option value="9-1">نهم ۱</option>
                                <option value="9-2">نهم ۲</option>
                            </select>
                        </div> -->
                            <div class="mb-3">
