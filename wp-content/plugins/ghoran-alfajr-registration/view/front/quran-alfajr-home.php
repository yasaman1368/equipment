    ...
    <body>
        ...
        <div class="container mt-4">
            <div class="section-title">
                <i class="fas fa-user-graduate"></i> رشته‌های مسابقه
            </div>

            <div class="highlight rounded shadow">
                <h5>🧔 برادران بزرگسال</h5>
                <p>ویژه قاریان و حافظان استان بوشهر</p>
                <ul class="list-group">
            ...
            <div class="highlight rounded shadow">
                <h5>🧑🏼‍🦰 برادران نوجوان</h5>
                <p>ویژه شهرستان دیر (۹ تا ۱۶ سال)</p>
                <p>متولدین ۲۰ بهمن ۱۳۹۵ تا ۲۰ بهمن ۱۳۸۷</p>
                <ul class="list-group">
            ...
            <div class="highlight rounded shadow">
                <h5>🧕 خواهران بزرگسال</h5>
                <p>ویژه شهرستان‌های دیر و کنگان، عسلویه، جم</p>
                <ul class="list-group">
                    <li class="list-group-item">💠 حفظ کل</li>
                    <li class="list-group-item">💠 حفظ ۲۰ جزء</li>
                    <li class="list-group-item">💠 حفظ ۱۰ جزء</li>
            ...
            <div class="highlight rounded shadow">
                <h5>👦 برادران و خواهران نونهال</h5>
                <p>ویژه شهرستان دیر (زیر ۹ سال)</p>
                <p>متولدین ۲۱ بهمن ۱۳۹۵ به بعد</p>
                <ul class="list-group">
