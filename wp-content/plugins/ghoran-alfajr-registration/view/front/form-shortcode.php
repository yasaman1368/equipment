                ...
                <fieldset>
                    <div class="container">
                        <div class="row">
                            ...
                            <!-- Form Name -->
                            <div class="fs-1 p-2 bg-dark text-white text-center rounded-2 mt-5 mb-2">فرم ثبت نام مسابقات قرآن</div>
                            ...
                            <div class="form-group m-2">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input id="female" class="form-check-input" type="radio" name="gender" value="زن" required />
                                        <label class="form-check-label" for="female">زن</label>
                                    </div>
                                    <div class="form-check">
                                        <input id="male" class="form-check-input" type="radio" name="gender" value="مرد" required />
                            ...
                            <div class="form-group m-2">
                                ...
                                <div class="col-md-6 selectContainer">
                                    <div class="input-group">
                                        ...
                                        <select name="age" id="age" class="form-control selectpicker show-form" required>
                                            <option value="">گروه سنی خود را انتخاب کنید</option>
                                            <option value="زیر 16 سال">زیر 16 سال</option>
                            ...
                            <div class="form-group m-2">
                                <label class="col-sm-6 control-label p-2">رشته مسابقه:</label>
                                <div class="col-md-6 selectContainer">
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="bi bi-trophy"></i></span>
                                        <select name="fieldMatch" id="field" class="form-control selectpicker show-form" required>
                                            <option value="">رشته مسابقه را انتخاب کنید...</option>
                                            <option value="حفظ 10 جزء">حفظ 10 جزء</option>
                                            <option value="حفظ 5 جزء">حفظ 5 جزء</option>
                                            <option value="حفظ 3 جزء">حفظ 3 جزء</option>
                                            <option value="حفظ 1 جزء">حفظ 1 جزء</option>
                                            <option value="اذان">اذان</option>
                                            <option value="قرائت تقلیدی">قرائت تقلیدی</option>
                                            <option value="قرائت تدویر">قرائت تدویر(ترتیل)</option>
                                            <option value="مفاهیم">مفاهیم</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
