...
class Router
{
    ...
    {
        return end(explode('/', strtok($request_uri, '?')));
    }
    ...
    {
        return YAS_SCP_DIR . 'panel/Controller/' . $controller_name . '.php';
    }
    ...
    {
        // include YAS_SCP_DIR . '404.php'; // Adjust the path as necessary
        ...
        // Optionally, you can exit or redirect to a different page
        // exit; // Uncomment to stop further execution
    }
}
